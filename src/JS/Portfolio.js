...
<input type="radio" name="radio-btn" id="img-0" defaultChecked />
    <li class="slide-container">
        ...
        <div className="biznaz1">
            ...
            <div className="port1colleft">
                <img alt="pic1" className="picvv" src={logor}></img>
            </div>
    ...
    <li class="slide-container">
        ...
        <div className="biznaz1">
            ...
            <div className="port1colleft">
                <img alt="pic2" className="picvv" src={Cam1}></img>
            </div>
            <div className="port1colright">
    ...
    <li class="slide-container">
        ...
        <div className="biznaz1">
            ...
            <div className="port1colleft">
                <img alt="pic3" className="picvv" src={Webz}></img>
            </div>
            <div className="port1colright">
    ...
    <li class="slide-container">
        ...
        <div className="biznaz1">
            ...
            <div className="port1colleft">
                <img alt="pic4" className="picvv" src={Picv}></img>
            </div>
            <div className="port1colright">
    ...
    <li class="slide-container">
        ...
        <div className="biznaz1">
            ...
            <div className="port1colleft">
                <img alt="pic5" className="picvv" src={Pic222}></img>
            </div>
            <div className="port1colright">
    ...
    <li class="slide-container">
        ...
        <div className="biznaz1">
            ...
            <div className="port1colleft">
                <img alt="pic5" className="picvv" src={Rpi}></img>
            </div>
            <div className="port1colright">
    ...
    <li class="slide-container">
        ...
        <div className="biznaz1">
            ...
            <div className="port1colleft">
                <img alt="pic6" className="picvv" src={Kboard}></img>
            </div>
            <div className="port1colright">
    ...
    <li class="slide-container">
        ...
        <h1 className="headcol1">Custom PC</h1>
            <div className="port1colleft">
                <img alt="pic7" className="picvv" src={Puter}></img>
            </div>
            <div className="port1colright">
    ...
    <li class="slide-container">
        ...
        <div className="port1colleft">
            <img alt="pic8" className="picvv" src={Ghat}></img>
        </div>
        <div className="port1colright">
